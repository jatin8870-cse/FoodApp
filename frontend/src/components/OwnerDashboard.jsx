      ...
      {myShopData &&
        <div className='w-full flex flex-col items-center gap-6 px-4 sm:px-6'>
          ...
          {myShopData.items.length == 0 &&
            <div className='flex justify-center items-center p-4 sm:p-6'>
              <div className='w-full  max-w-md bg-white shadow-lg rounded-2xl p-6 border-gray-100  hover:shadow-xl transition-shadow duration-300'>
                <div className="flex flex-col items-center text-center">
                  ...
                  <button className='bg-[#ff4d2d] text-white px-5 sm:px-6 py-2 rounded-full font-medium shadow-md hover:bg-orange-600 transition-colors duration-200 cursor-pointer' onClick={() => navigate("/add-food")}>
                    Add Food
                  </button>
                </div>
              </div>
            ...
            {myShopData.items.length>0 && <div className='flex flex-col item-center gap-4 w-full max-w-3xl'>
