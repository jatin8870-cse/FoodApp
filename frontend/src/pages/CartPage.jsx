...
const CartPage = () => {
            ...
            <div className='w-full max-w-[800px]'>
                ...
                {cartItems.length == 0 ? (
                    ...
                    <>
                        ...
                        <div className='mt-6 bg-white p-4  rounded p-4 rounded-xl shadow flex
    justify-between items-center border'>
                        ...
                        <div className='mt-4 flex justify-end'>
                            ...
                            font-medium hover:bg-[#e64526] transition cursor-pointer'onClick={() => navigate("/CheckOut")}>CheckOut</button>
                        </div>
                    </>
                )
                }
